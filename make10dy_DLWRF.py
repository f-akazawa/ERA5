...
if __name__ == '__main__':
    ...
    INPUT_FILE_TEMPLATE = '../DLWRF/surface_longwave_radiation_{}.nc'

    # 3. NetCDFファイル内の変数名
    #VARIABLE_NAME = 'msdwlwrf'
    VARIABLE_NAME = 'avg_sdlwrf'
   
    # 4. 出力されるPickleファイルの接頭辞
    OUTPUT_FILENAME_PREFIX = '../10dy/10dy_dlwrf/dlwrf_10dy'
