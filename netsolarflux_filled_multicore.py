...
# --- 設定項目 ---
pickle_directory = 'output_fluxes_180x360/'
start_year = 2024
end_year = 2025
input_filename_format = '{year}_NetSolarFlux_period_averages.pkl'
output_filename_format = '{year}_filled_NetSolarFlux.pkl'
max_iterations = 1000
tolerance = 1e-7
